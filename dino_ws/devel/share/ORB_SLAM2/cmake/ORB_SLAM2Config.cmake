...
if("TRUE" STREQUAL "TRUE")
  set(ORB_SLAM2_SOURCE_PREFIX /root/dino_ws/src/ORB_SLAM2)
  set(ORB_SLAM2_DEVEL_PREFIX /root/dino_ws/devel)
  ...
  set(ORB_SLAM2_INSTALL_PREFIX /root/dino_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ORB_SLAM2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/dino_ws/src/ORB_SLAM2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ORB_SLAM2_NUM_DUMMY_TARGETS)
      set(ORB_SLAM2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ORB_SLAM2::wrapped-linker-option${ORB_SLAM2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ORB_SLAM2_NUM_DUMMY_TARGETS "${ORB_SLAM2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ORB_SLAM2::wrapped-linker-option${ORB_SLAM2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ORB_SLAM2_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND ORB_SLAM2_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ORB_SLAM2_EXPORTED_TARGETS ${${ORB_SLAM2_dep}_EXPORTED_TARGETS})
endforeach()
